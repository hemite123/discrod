...
def InputUser(self,id,name):
    senddata = requests.post(url="https://projectdiscord.000webhostapp.com/userdata.php",json={"user_id":id,"name":name,"balance":0,"datapost":"insert"},headers={"Content-Type":"application/json",'Accept': 'text/plain'})
    print(senddata.text)
